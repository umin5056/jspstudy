...
/**
 * Servlet implementation class UploedServlet
 */
...
public class UploadServlet extends HttpServlet {
	...
	/*
	   ...
	   3. 압축 해제 후 lib에 있는 cos.jar 파일을 WEB-INF에 lib로 등록한다.	
	 */
	...
	/*
	   ...
	   3. cos.jar가 지원하는 MultipartRequest 클래스를 이용해서 파일업로드를 처리할 수 있다.
	 */
		
	 // 업로드 경로 (서버의 real path를 사용하거나 일반 경로를 사용할 수 있다.)
		
	// getRealPaht의 매개변수는 폴더를 지정하고, 없으면 생성해준다.	
